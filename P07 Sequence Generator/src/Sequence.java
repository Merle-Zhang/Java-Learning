...
public class Sequence implements Iterable<Integer> {
  ...
  public Sequence(int[] command) {
    ...
    switch (sequenceType) {
      ...
      case GEOMETRIC: // call the constructor of the GeometricSequenceGenerator class to create
        ...
        break;
      case FIBONACCI:// call the constructor of the FibonacciSequenceGenerator class to create
        // an iterator over an Fibonacci sequence with size command[1]
        sequenceIterator = new FibonacciSequenceGenerator(command[1]);
        break;
      case DIGIT_PRODUCT:// call the constructor of the DigitProductSequenceGenerator class to
                         // create
        // an iterator over an DigitProduct sequence with initial element command[1], size
        // command[2]
  ...
  /**
   * return the iterator of this sequence, which is the field sequenceIterator
   * 
